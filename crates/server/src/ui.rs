...
impl eframe::App for LauncherApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            // CentralPanel including padding. All three screens (Main,
            // Crashed, Farewell) share the same vortex backdrop for visual
            // continuity; per-screen VortexParams tuning (e.g. urgent
            // iris-close on crash, gentle iris-close on farewell) is a
            // 4.15a.7 polish item.
